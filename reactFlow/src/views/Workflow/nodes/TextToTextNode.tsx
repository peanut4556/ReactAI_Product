...
type TextToTextNodeData = {
  label?: string;
  text?: string;
  [key: string]: unknown;
};

const TextToTextNode = ({ id, data, isConnectable }: NodeProps<Node<TextToTextNodeData>>) => {
        ...
        <div className="p-4 flex flex-col gap-4 bg-white">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input.TextArea 
              ...
              className="nodrag text-sm rounded-lg bg-gray-50 border-gray-200 hover:bg-white focus:bg-white transition-colors"
              variant="filled"
              value={data.text || ''}
